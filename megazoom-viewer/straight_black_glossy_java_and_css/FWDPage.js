...
function setupMenu(){
	...
	pageMenu_do = new FWDPageMenu({
		...
		shadowPath:"straight_black_glossy_graphics/menuShadow.jpg",
		maxWidth:950,
		buttonNormalColor:"#6e6f6f",
		buttonSelectedColor:"#0099ff",
		buttonsHolderBackgroundColor:"#000000",
		spacerColor:"#2f2f2f"
	});
...
function setupThumbsHolder(){
	...
	pageThumbs_do = new FWDPageThumbs({
		...
		imagesPath:["straight_black_glossy_graphics/image1.jpg", "straight_black_glossy_graphics/image2.jpg", "straight_black_glossy_graphics/image3.jpg", "straight_black_glossy_graphics/image4.jpg"],
...
function onThumbPressedHandler(e){
	...
	if(e.id == 1){
		openedWindow = window.open("straight-black-glossy-full-screen.html");
	}else if(e.id == 2){
		openedWindow = window.open("straight-black-glossy-thumbs.html");
	}else if(e.id == 3){
		setupLightBox();
	}
}
...
function setupReadMoreButton(){
	...
	readMoreButton_do = new FWDPageSimpleButton(
			"straight_black_glossy_graphics/readMoreS.jpg",
			"straight_black_glossy_graphics/readMoreN.jpg",
			118, 25);
...
function setupLightBox(){
	...
	lightBoxViewer = new FWDMegazoom({
		...
		skinPath:"skin_straight_black_glossy/skin/",
		imagePath:"skin_straight_black_glossy/imageToZoom.jpg",
		...
		lightBoxBackgroundColor:"#666666",
		//----controller----//
		...
		//----navigator----//
		showNavigator:"yes",
		navigatorImagePath:"skin_straight_black_glossy/navigatorImage.jpg",
