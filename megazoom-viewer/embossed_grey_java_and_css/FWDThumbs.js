...
function init(){
	...
	mainProductHolder_el.style.marginTop = "12px"; 
...
function setupThumbsHolder(){
	...
	pageThumbs_do = new FWDPageThumbs({
		...
		imagesPath:["embossed_grey_graphics/imageThumbs1.jpg", "embossed_grey_graphics/imageThumbs2.jpg", "embossed_grey_graphics/imageThumbs3.jpg", "embossed_grey_graphics/imageThumbs4.jpg"],
...
function onThumbPressedHandler(e){
	...
	if(e.id == 0){
		setupZoomer("embossed_grey_graphics/imageToZoom.jpg", "embossed_grey_graphics/navigatorImage.jpg", "megazoomPlayList", 2490, 3300, "#000000", "#000000");
	}else if(e.id == 1){
		setupZoomer("embossed_grey_graphics/imageToZoom2.jpg", "embossed_grey_graphics/navigatorImage2.jpg", "megazoomPlayList", 2490, 3300, "#FFFFFF", "#FFFFFF");
	}else if(e.id == 2){
		setupZoomer("embossed_grey_graphics/imageToZoom3.jpg", "embossed_grey_graphics/navigatorImage3.jpg", "megazoomPlayList", 2490, 3300, "#000000", "#000000");
	}else if(e.id == 3){
		setupZoomer("embossed_grey_graphics/imageToZoom4.jpg", "embossed_grey_graphics/navigatorImage4.jpg", "megazoomPlayList", 2490, 3300, "#000000", "#000000");
	}
}
