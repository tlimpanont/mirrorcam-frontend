...
function setupMenu(){
	...
	pageMenu_do = new FWDPageMenu({
		...
		shadowPath:"round_silver_graphics/menuShadow.jpg",
		maxWidth:950,
		buttonNormalColor:"#666666",
		buttonSelectedColor:"#0099ff",
		buttonsHolderBackgroundColor:"#FFFFFF",
		spacerColor:"#cccccc"
	});
...
function setupThumbsHolder(){
	...
	pageThumbs_do = new FWDPageThumbs({
		...
		imagesPath:["round_silver_graphics/image1.jpg", "round_silver_graphics/image2.jpg", "round_silver_graphics/image3.jpg", "round_silver_graphics/image4.jpg"],
...
function onThumbPressedHandler(e){
	...
	if(e.id == 1){
		openedWindow = window.open("round-silver-full-screen.html");
	}else if(e.id == 2){
		openedWindow = window.open("round-skin-silver-thumbs.html");
	}else if(e.id == 3){
		setupLightBox();
	}
}
...
function setupReadMoreButton(){
	...
	readMoreButton_do = new FWDPageSimpleButton(
			"round_silver_graphics/readMoreS.jpg",
			"round_silver_graphics/readMoreN.jpg",
			118, 25);
...
function setupLightBox(){
	...
	lightBoxViewer = new FWDMegazoom({
		...
		imagePath:"skin_round_silver/imageToZoom.jpg",
		...
		//----navigator----//
		showNavigator:"yes",
		navigatorImagePath:"skin_round_silver/navigatorImage.jpg",
