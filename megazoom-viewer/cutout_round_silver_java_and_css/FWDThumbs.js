...
function setupThumbsHolder(){
	...
	pageThumbs_do = new FWDPageThumbs({
		...
		imagesPath:["cutout_round_silver_graphics/imageThumbs1.jpg", "cutout_round_silver_graphics/imageThumbs2.jpg", "cutout_round_silver_graphics/imageThumbs3.jpg", "cutout_round_silver_graphics/imageThumbs4.jpg"],
...
function onThumbPressedHandler(e){
	...
	if(e.id == 0){
		setupZoomer("cutout_round_silver_graphics/imageToZoom.jpg", "megazoomPlayList", "cutout_round_silver_graphics/navigatorImage.jpg", 5000, 2926);
	}else if(e.id == 1){
		setupZoomer("cutout_round_silver_graphics/imageToZoom2.jpg", "megazoomPlayList", "cutout_round_silver_graphics/navigatorImage2.jpg", 5000, 2926);
	}else if(e.id == 2){
		setupZoomer("cutout_round_silver_graphics/imageToZoom3.jpg", "megazoomPlayList", "cutout_round_silver_graphics/navigatorImage3.jpg", 5000, 2926);
	}else if(e.id == 3){
		setupZoomer("cutout_round_silver_graphics/imageToZoom4.jpg", "megazoomPlayList", "cutout_round_silver_graphics/navigatorImage4.jpg", 5000, 2926);
	}
}
