...
function setupThumbsHolder(){
	...
	pageThumbs_do = new FWDPageThumbs({
		...
		imagesPath:["minimal_dark_graphics/imageThumbs1.jpg", "minimal_dark_graphics/imageThumbs2.jpg", "minimal_dark_graphics/imageThumbs3.jpg", "minimal_dark_graphics/imageThumbs4.jpg"],
...
function onThumbPressedHandler(e){
	...
	if(e.id == 0){
		setupMegazoom("minimal_dark_graphics/imageToZoom.jpg", "minimal_dark_graphics/navigatorImage.jpg", "megazoomPlayList", 3600, 2809, "#FFFFFF");
	}else if(e.id == 1){
		setupMegazoom("minimal_dark_graphics/imageToZoom-brown.jpg", "minimal_dark_graphics/navigatorImage-brown.jpg", "megazoomPlayList", 3600, 2809, "#f1e9d2");
	}else if(e.id == 2){
		setupMegazoom("minimal_dark_graphics/imageToZoom-black.jpg", "minimal_dark_graphics/navigatorImage-black.jpg", "megazoomPlayList", 3600, 2809, "#000000");
	}else if(e.id == 3){
		setupMegazoom("minimal_dark_graphics/imageToZoom-blue.jpg", "minimal_dark_graphics/navigatorImage-blue.jpg", "megazoomPlayList", 3600, 2809, "#FFFFFF");
	}
}
